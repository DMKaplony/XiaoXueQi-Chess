...
# Generated by qmake (2.01a) (Qt 4.8.2) on: Mon Jun 25 17:10:00 2012
# Project:  project.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/project1.0.0/ && $(COPY_FILE) --parents Chessman.h def.h Image.h Point.h Yi.h .tmp/project1.0.0/ && $(COPY_FILE) --parents Chessman.cpp Image.cpp main.cpp Point.cpp Yi.cpp .tmp/project1.0.0/ && (cd `dirname .tmp/project1.0.0` && $(TAR) project1.0.0.tar project1.0.0 && $(COMPRESS) project1.0.0.tar) && $(MOVE) `dirname .tmp/project1.0.0`/project1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/project1.0.0
...
compiler_moc_header_make_all: moc_Image.cpp moc_Yi.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_Image.cpp moc_Yi.cpp
...
moc_Yi.cpp: def.h \
		...
		Image.h \
		Yi.h
	/usr/local/Trolltech/Qt-4.8.2/bin/moc $(DEFINES) $(INCPATH) Yi.h -o moc_Yi.cpp
...
Yi.o: Yi.cpp Image.h \
		...
		Point.h \
		Yi.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Yi.o Yi.cpp

moc_Image.o: moc_Image.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Image.o moc_Image.cpp

moc_Yi.o: moc_Yi.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_Yi.o moc_Yi.cpp
